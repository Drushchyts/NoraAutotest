...
public class AddDistributorPage extends AbstractPage {
    ...
    private String addDistributorButton = "//body/div[1]/div[2]/div[2]/section[1]/div[1]/ui-view[1]/ui-view[1]/div[1]/div[1]/div[1]/a[1]";
    ...
    public AddDistributorPage clickDistributorsModButton() throws InterruptedException {
        sleep(2000);
        waitForElementVisible(getElementBy(distributorsButton));
